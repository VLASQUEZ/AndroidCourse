...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition camera = new CameraPosition.Builder()
                .target(sydney)
                .zoom(18)//Zoom de la camara max 21
                .bearing(90)//Inclinacion hacia el este 0-360
                .tilt(30)//3D effect in grades <90º
                .build();
        ...
        mMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                Toast.makeText(MapsActivity.this, "Latitud:"+marker.getPosition().latitude +"\n"+ "Longitud:"+marker.getPosition().longitude,Toast.LENGTH_SHORT).show();
